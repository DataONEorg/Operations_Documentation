...
.. glossary::
  ...
  DataONE Common Library
    ...
    It is a dependency of :term:`DataONE Client Library`.
  ...
  subject
    ...
    must hold an `X.509` certificate for that subject.

    DataONE defines a
    serialization method in which a subject is derived from the :term:`DN` in
    a :term:`X.509` certificate.
  ...
  Tier
    ...
    :doc:`DataONE Member Node Tiers <select-tier>`.
